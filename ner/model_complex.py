...
class Model:
    ...
    def build_model(self):
        ...
        #     # embedding_character = tf.layers.conv2d(embedding_character, self.parameter['char_embedding_size'], (3, 3), padding='SAME', kernel_initializer=tf.contrib.layers.xavier_initializer())
        #     # embedding_character = tf.layers.batch_normalization(embedding_character, training=tf.less(self.dropout_rate, 1.0))
